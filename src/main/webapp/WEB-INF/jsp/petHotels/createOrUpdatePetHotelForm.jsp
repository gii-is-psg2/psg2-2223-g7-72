...
<petclinic:layout pageName="petHotels">
	...
	<jsp:body>
		<h2>
			<c:if test="${petHotel['new'] }">New </c:if> Pet Hotel
		</h2>
                ...
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${petHotel['new']}">
                        	<button class="btn btn-default" type="submit">Add Pet Hotel</button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-default" type="submit">Update Pet Hotel</button>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
